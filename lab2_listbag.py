...
class ListBag:
    ...
    def remove(self, item: any) -> any:
        ...
        if item not in self._elems:
            raise ValueError(f"bag.remove(item): {item} not in bag")
    ...
    def grab(self) -> any:
        ...
        grabbed_item = random.choice(self._elems)
        
        self._elems.remove(grabbed_item)
    ...
    def __add__(self, other: 'ListBag') -> 'ListBag':
        ...
        # Concatenate the lists and create a new ListBag
        concatenated_items = self._elems + other._elems
        return ListBag(concatenated_items)
    ...
    def __eq__(self, other: 'ListBag') -> bool:
        ...
        self._elems.sort()
        other._elems.sort()
        # Compare the sets of items to check for equality
